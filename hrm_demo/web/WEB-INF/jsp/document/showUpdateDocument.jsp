...
<html>
	<head>
		...
		if(${message != null }){
			alert("${message}");
			window.location.href="${ctx}/documentlist.action";
		}
		...
		<table width="100%" height="90%" border="0" cellpadding="10" cellspacing="0" class="main_tabbor">
		  	<tr valign="top">
			    <td>
				 ...
				 <form id="documentForm" name="documentForm" action="${ctx }/documentupdatesave.action?id=${document.id}" enctype="multipart/form-data" method="post">
                        <!-- 隐藏表单，flag表示添加标记 -->
