...
<html>
	...
	if(${message != null }){
		alert("${message}");
		window.location.href="${ctx}/employeelist.action";
	}
	
	$(function(){
		// 控制文档加载完成以后 选中性别 
		$("#sex").val("${employee.sex}");
		$("#job_id").val("${employee.j_id.jid}");
...
<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
  <tr valign="top">
    <td>
    	 <form action="${ctx}/saveEmployee.action" id="employeeForm" method="post">
			<!-- 隐藏表单，flag表示添加标记 -->
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr><td class="font3 fftd">
		    	<table>
		    		<tr>
		    			...
		    			<td class="font3 fftd">身份证号码：<input type="text" name="cardId" id="cardId" size="20" value="${employee.card_id }"/></td>
		    		</tr>
		    		<tr>
		    		...
		    		<tr>
		    			<td class="font3 fftd">学历：<input name="education" id="education" size="20" value="${employee.educate }"/></td>
			...
			<tr>
				<td class="font3 fftd">
					...
					QQ&nbsp;&nbsp;号码：<input name="qqNum" id="qqNum" size="20" value="${employee.qq_num }"/>
				</td>
			</tr>
			<tr><td class="main_tdbor"></td></tr>
			...
			<tr>
				<td class="font3 fftd">
					...
					邮政编码：<input name="postCode" id="postCode" size="20" value="${employee.post_code }"/>
				</td>
			</tr>
			<tr><td class="main_tdbor"></td></tr>
				...
				<td class="font3 fftd">
					...
					<select  name="dept_id" style="width:100px;">
						   ...
						   <c:forEach items="${requestScope.deptList }" var="dept">
						   		<c:choose>
			    					<c:when test="${employee.d_id.did == dept.did }">
